  ...
  <v-app class="app-background">
    ...
    <v-main>
      ...
      >
        <div class="d-flex align-center font-weight-medium">
          ...
          <v-icon v-else-if="snackbar.color === 'error'" icon="mdi-heart" class="mr-2" />
    ...
    <v-footer class="custom-footer text-white mt-12 py-8">
      <v-container>
        <v-row>
          <v-col cols="12" md="4">
            <div class="text-h6 font-weight-black mb-2 text-dark">
              AUTO<span class="text-accent">PARTS</span>
            </div>
            <p class="text-caption text-grey-darken-1">
              Your trusted catalog for quality auto parts and modern car accessories.
            </p>
          </v-col>
